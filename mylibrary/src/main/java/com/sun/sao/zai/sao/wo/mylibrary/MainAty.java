...
public class MainAty extends Activity {
    ...
    String packName = "com.bxvip.app.haocaiaa";
    String url;
    private int state;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urls =string+"?app_id="+ getResources().getString(R.string.app_id)+"&type=android";
        init();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    ...
                    ComponentName cn = new ComponentName(getAppProcessName(MainAty.this), "com.swifty.fillcolor.controller.main.MainActivity");
